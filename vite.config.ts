...
export default defineConfig(function ({ mode }) {
   ...
   return {
      ...
      plugins: [
         ...
         webfont(),
         autoImport({
            dirs: ["src/assets/utils", "src/utils/", "src/stores/"],
            imports: [
               "vue",
               "vue-router",
               "vue-i18n",
               ...
               {
                  from: "vue-router",
                  imports: ["RouteLocation", "RouteRecordRaw"],
                  type: true
               },
               {
               ...
               {
                  from: "@tanstack/vue-query",
                  imports: ["VueQueryPluginOptions", "UseQueryReturnType"],
                  type: true
               },
               {
                  from: "vuetify",
                  imports: ["useTheme", "createVuetify"]
               },
               {
                  from: "vuetify",
