...
declare global {
  ...
  const mockAxios: typeof import('./src/utils/axios').mockAxios
...
declare global {
  ...
  // @ts-ignore
  export type { Neverify, UnwrapReadonlyArray, NestedKeys, Strict, IDefaultFields, ITranslate, IOrderStore, THeader, TNotify, TSnackbar, TResponse, TParams, TQuery, TMutation, TList, TDataTable, TMultiSelect, TDateField, TToolbar, TCard, TContainer, TBtn, TField, TAvatar, TAlert } from './src/utils/types'
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly mockAxios: UnwrapRef<typeof import('./src/utils/axios')['mockAxios']>
